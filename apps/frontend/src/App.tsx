...
const LazyClassManagementPage = lazy(() => import('@/pages/IdentityDirectoryPage').then(m => ({ default: () => <m.IdentityDirectoryPage kind="classes" /> })))
const LazyTeacherManagementPage = lazy(() => import('@/pages/IdentityDirectoryPage').then(m => ({ default: () => <m.IdentityDirectoryPage kind="teachers" /> })))
const LazyFamilyManagementPage = lazy(() => import('@/pages/IdentityDirectoryPage').then(m => ({ default: () => <m.IdentityDirectoryPage kind="families" /> })))
const LazyParentManagementPage = lazy(() => import('@/pages/IdentityDirectoryPage').then(m => ({ default: () => <m.IdentityDirectoryPage kind="parents" /> })))
const LazyStudentManagementPage = lazy(() => import('@/pages/IdentityDirectoryPage').then(m => ({ default: () => <m.IdentityDirectoryPage kind="students" /> })))
const LazyParentStudentPage = lazy(() => import('@/pages/IdentityDirectoryPage').then(m => ({ default: () => <m.IdentityDirectoryPage kind="relationships" /> })))
