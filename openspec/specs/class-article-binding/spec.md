# class-article-binding Specification

## Purpose

Class targeting for newsletter articles: admins assign shared vs class-specific visibility; the system validates bindings at authoring time; personalized delivery respects eligibility and preserves newsletter order.
