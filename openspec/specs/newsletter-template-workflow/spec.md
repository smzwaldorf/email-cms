# newsletter-template-workflow Specification

## Purpose

Admin workflow for creating newsletter templates from existing newsletters and creating new draft newsletters from templates, with isolation between source, template, and derived content.
