# student-association-management Specification

## Purpose

Administrators manage student records and their links to classes and families so personalization and targeting use consistent identity rules, referential integrity for enrollments and family links, non-destructive lifecycle (active/inactive), and listings that default to active students while supporting maintenance views.
