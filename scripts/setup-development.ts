 ...
 * - harryworld@gmail.com (HACK Family, father)
 * - hacktofire@gmail.com (HACK Family, mother)
 *
...
const testFamilies = [
  ...
  {
    id: 'eebe9de9-4fa8-46d6-a6ca-5bff46d072a3',
    family_code: 'BB',
    family_name: 'HACK Family',
    guardian_email: 'harryworld@gmail.com',
  },
]
...
const testUsers = [
  ...
  },
  {
    ...
    role: 'parent',
    familyId: 'eebe9de9-4fa8-46d6-a6ca-5bff46d072a3', // HACK Family
    relationship: 'father',
  },
  {
    email: 'hacktofire@gmail.com',
    password: 'kaelipassword123',
    role: 'parent',
    familyId: 'eebe9de9-4fa8-46d6-a6ca-5bff46d072a3', // HACK Family
    relationship: 'mother',
  },
...
const testChildren = [
  ...
  {
    id: '278f016a-68f9-48fc-a3de-9ad25915bba3',
    name: 'Alton',
    familyId: 'eebe9de9-4fa8-46d6-a6ca-5bff46d072a3', // HACK Family
    classId: 'XCYB', // 辛丑乙
  },
  {
    id: 'b9f9f6c4-c31c-4cd5-9f9d-0f8206a6b7d1',
    name: 'Caton',
    familyId: 'eebe9de9-4fa8-46d6-a6ca-5bff46d072a3', // HACK Family
    classId: 'JIACHEN', // 甲辰
  },
...
async function setupDevelopment() {
  ...
  try {
      ...
      try {
        ...
        if (user.role === 'parent' && 'familyId' in user) {
          ...
          const { error: enrollError } = await supabase.from('family_enrollment').insert({
            ...
            parent_id: userId,
            relationship: userWithFamily.relationship ?? 'mother',
          })
    ...
    console.log('  harryworld@gmail.com → HACK Family seeded as father / primary guardian')
    console.log('  hacktofire@gmail.com → HACK Family seeded as mother\n')
  } catch (err) {
