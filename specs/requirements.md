...
**建立日期**: 2025-11-15
**需求來源**: 初始專案規劃
**狀態**: ✅ 已記錄並展開為 User Stories；部分需求已實作並進入營運追蹤
...
以 User Stories 來說明這個系統的功能需求

### Email Newsletter 需求
1. 不同班級會有對應的 Block
2. 通過頁面發送，每周 copy template，進行內容修改
3. 需要歸類統計來看開信率及點擊率
4. 家長有幾個孩子，不用收多封郵件
5. 收到的電郵都是看起來一樣的，CMS 判斷身份來顯示對應的班級大小事
6. 通過 API 更新用戶自定義資料，例如每位家長應看到的班級大小事內容

### CMS 需求
7. 可以按照每週的，善話來去顯示多篇文章
8. 可以新增每週的文章。可以設定文章的順序
9. 不同的班級有特定權限看其中一篇文章，家長只可看到自己小孩班級的，名為「班級大小事」
10. 每一篇文章都有獨立的 URL。然後這一週的系列文章也是有一個 URL 來去標記
11. 如果我有兩個小孩在不同的班級，我希望可以一併看這兩個班級的，班級大小事
12. 同一周的文章，可以，通過導航快速地去滑動切換，看上一篇下一篇文章
13. 文章的內容可以有圖片跟文字
14. 也可以加入多媒體，像錄音、影片（embed YouTube）
15. 老師可以去編輯這些文章的內容
16. 整合統計數據
...
**對應 User Story**: US-CMS-009 ✅ 核心功能已實作
...
**對應 User Story**: US-CMS-010 ✅ 核心功能已實作
...
**對應 User Story**: US-CMS-012 ✅ 核心功能已實作
...
|------------|---------|----------------|--------|------|
| EMAIL-1 | 班級對應的內容區塊 | US-EMAIL-001 | P1 | 🔄 部分基礎已具備，待郵件整合完成 |
| EMAIL-2 | 每週複製模板 | US-EMAIL-002 | P2 | 📋 待開發 |
| EMAIL-3 | 開信率與點擊率統計 | US-EMAIL-003 | P2 | ✅ 核心功能已實作 |
...
| CMS-2 | 新增文章 | US-CMS-002 | P1 | 🔄 核心流程已實作 |
| CMS-3 | 設定文章順序 | US-CMS-003 | P2 | 📋 待開發 |
| CMS-4 | 班級權限控制 | US-CMS-004 | P1 | 🔄 核心權限已實作 |
| CMS-5 | 文章獨立 URL | US-CMS-005 | P1 | ✅ 已實作 |
| CMS-6 | 週報統一 URL | US-CMS-006 | P1 | ✅ 已實作 |
| CMS-7 | 多班級合併查看 | US-CMS-007 | P1 | 🔄 基礎資料模型已具備，待個人化郵件整合 |
| CMS-8 | 文章導航切換 | US-CMS-008 | P2 | ✅ 已實作 |
| CMS-9 | 圖片與文字 | US-CMS-009 | P1 | ✅ 已實作 |
| CMS-10 | 多媒體支援 | US-CMS-010 | P2 | ✅ 已實作 |
| CMS-11 | 老師編輯權限 | US-CMS-011 | P2 | 🔄 管理與資料基礎已具備，待權限 UI 完整化 |
| CMS-12 | 整合統計數據 | US-CMS-012 | P3 | ✅ 已實作 |
...
### 2026-03-19
- **狀態更新**：分析與報表、富文本媒體能力、媒體治理流程已完成核心實作
- **追溯矩陣更新**：調整 EMAIL-3、CMS-2、CMS-4、CMS-7、CMS-9、CMS-10、CMS-11、CMS-12 的實作狀態
