...
describe('Integration: YouTube Delete Functionality (T065)', () => {
  describe('FR-012: Video Node Deletion', () => {
    it('should render editor with YouTube video', () => {
      render(<TestEditor />)
  ...
  describe('Delete Workflow', () => {
    it('should demonstrate video node structure', () => {
    ...
    it('should have video surrounded by paragraph content', () => {
      const { container } = render(<TestEditor />)
  ...
  describe('SC-004: Delete Interaction (95%+ reliability)', () => {
    it('should show deletion hint to user', () => {
      const { container } = render(<TestEditor />)
    ...
    it('should keep content accessible for deletion', () => {
      const { container } = render(<TestEditor />)
  ...
  describe('Video Node Integrity', () => {
    ...
    it('should have video wrapper in content', () => {
      const { container } = render(<TestEditor />)
    ...
    it('should have iframe in video node', () => {
      const { container } = render(<TestEditor />)
  ...
  describe('Deletion Prerequisites', () => {
    it('should have YouTube node capable of deletion', () => {
      const { container } = render(<TestEditor />)
    ...
    it('should support selection of entire video node', () => {
      const { container } = render(<TestEditor />)
    ...
    it('should preserve content structure for undo/redo', () => {
      const { container } = render(<TestEditor />)
  ...
  describe('User Experience', () => {
    ...
    it('should show content ready for deletion operation', () => {
      const { container } = render(<TestEditor />)
    ...
    it('should provide clear visual structure for interaction', () => {
      const { container } = render(<TestEditor />)
